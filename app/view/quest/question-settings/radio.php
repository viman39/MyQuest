...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea class="form-control snippet-loader-radio" id="radio-texts" rows="5"></textarea>
        </div>
    </div>
</div>
...
<script>
    ...
    $(".snippet-loader-radio").change(function(){
        if ( $("#question-text").val().trim() != "" && $("#radio-texts").val().trim() != "" ){
            $.ajax({
